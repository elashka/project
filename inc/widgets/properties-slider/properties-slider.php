<?php
/*
Widget Name: Theme Properties Slider widget
...
if ( class_exists('SiteOrigin_Widget') ){
	class Properties_Slider_Widget extends SiteOrigin_Widget {
		function __construct() {
			parent::__construct(
				'properties-slider-widget',
				__('Theme Properties Slider Widget', 'es-project'),
				array(
					'description' => __('Widget with slider of properties.', 'es-project'),
                    'has_preview' => false
				),
				array(
				),
		...
		function initialize(){
			...
			$this->register_frontend_scripts( array(
				array(
					...
					ES_PROJECT_VENDOR_SCRIPTS_URL . 'slick/slick/slick.min.js',
					array( 'jquery' ),
					null,
					true
				)
			...
			$this->register_frontend_scripts( array(
				array(
					'sow-properties-slider',
					ES_PROJECT_WIDGETS_URL . 'properties-slider/js/script.js',
					array( 'jquery', 'sow-properties-slider-slick' ),
					null,
					true
				)
			) );
...
siteorigin_widget_register('properties-slider-widget', __FILE__, 'Properties_Slider_Widget');